...
const Contact = () => {
  ...
  <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
    <div>
      ...
      Should you have any questions or require assistance with our services, please do not hesitate to contact us. Our dedicated team is here to support you and ensure your experience with BeautyPool is seamless and enjoyable.
      </p>
