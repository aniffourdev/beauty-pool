        ...
        <div className="lg:w-8/12">
          <div className="p-4">
            ...
            <div className="flex items-center mt-2">
              ...
              <span className="text-slate-800 text-sm font-semibold mx-2">•</span>
              <span className="text-slate-800 text-sm font-semibold">
                Open until {getCurrentOpeningTime(article!)}
              </span>
              <span className="text-slate-800 text-sm font-semibold mx-2">•</span>
              <span className="text-slate-800 text-sm font-semibold">{article?.Address}</span>
              <a
                ...
                <div className="mt-4">
                  {openingTimes.map((item, index) => (
                    <div key={index} className="flex items-center mt-2">
                      ...
                      ></span>
                      <span className={`ml-2 ${item.bold ? "font-bold" : ""}`}>
                        {item.day}
                      </span>
                      <span
                        className={`ml-auto ${item.bold ? "font-bold" : ""}`}
                      >
                        {item.time}
                      </span>
                    </div>
