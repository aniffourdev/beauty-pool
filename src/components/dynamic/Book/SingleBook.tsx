...
const SingleBook: React.FC<SingleBookProps> = ({ slug }) => {
  ...
  const allImages = [
    `https://brandlybook.store/assets/${article?.featured_image}`,
    ...(article?.galleries || []).map(
      (gallery) =>
        `https://brandlybook.store/assets/${gallery.directus_files_id.id}`
    ),
  ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {firstTwoImages.map((gallery, index) => (
                      ...
                      >
                        <Image
                          src={`https://brandlybook.store/assets/${gallery.directus_files_id.id}`}
                    ...
                    {mapCoordinates && (
                      ...
                      >
                        <div
                          ...
                          style={{
                            backgroundImage: `url(https://brandlybook.store/assets/12247141-da04-4eb2-bff5-205417bc924b?cache-buster=2024-12-07T13:14:36.000Z&key=system-large-contain)`,
                          }}
                        >
